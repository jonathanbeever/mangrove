  ...
  <app-layout title="Series">
    ...
    <div class="py-12">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div
          class="bg-white overflow-hidden shadow-xl sm:rounded-lg dark:bg-slate-900 shadow-inner shadow-sky-200 dark:shadow-cyan-500"
        >
          <div class="bg-white border-b border-gray-400 flex flex-row">
  ...
  methods: {
    ...
    ConvertMetaForPost: function () {
      if (this.meta.length === 0) {
        return null;
      } else if (this.meta.length < 0){
        // catch a strange edge case...
        // How can a file be negative in size
        return null;
      }
