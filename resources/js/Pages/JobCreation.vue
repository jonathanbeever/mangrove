        ...
        <div class="flex flex-col p-6 sm:px-20 bg-white border-b border-gray-200 w-full flex justify-center">
            ...
            <div class="flex flex-row w-full mt-[50px]">
                <div class="flex flex-col w-1/2">
                    ...
                    <div>
                        <div class="form-check mb-[10px]">
                            <input class="form-check-input appearance-none rounded-full h-4 w-4 border border-gray-300 bg-white checked:bg-blue-600 checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" v-on:click="onChange($event)" type="radio" name="indexRadio" id="aci" checked>
                            <jet-label class="form-check-label inline-block text-gray-800 text-1xl" for="aci">
                                ACI
                            </jet-label>
                        </div>
                        <div class="form-check mb-[10px]">
                            <input class="form-check-input appearance-none rounded-full h-4 w-4 border border-gray-300 bg-white checked:bg-blue-600 checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" v-on:click="onChange($event)" type="radio" name="indexRadio" id="ndsi">
                            <jet-label class="form-check-label inline-block text-gray-800 text-1xl" for="ndsi">
                                NDSI
                            </jet-label>
                        </div>
                        <div class="form-check mb-[10px]">
                            <input class="form-check-input appearance-none rounded-full h-4 w-4 border border-gray-300 bg-white checked:bg-blue-600 checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" v-on:click="onChange($event)" type="radio" name="indexRadio" id="aei">
                            <jet-label class="form-check-label inline-block text-gray-800 text-1xl" for="aei">
                                AEI
                            </jet-label>
                        </div>
                        <div class="form-check mb-[10px]">
                            <input class="form-check-input appearance-none rounded-full h-4 w-4 border border-gray-300 bg-white checked:bg-blue-600 checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" v-on:click="onChange($event)" type="radio" name="indexRadio" id="adi">
                            <jet-label class="form-check-label inline-block text-gray-800 text-1xl" for="adi">
                                ADI
                            </jet-label>
                        </div>
                        <div class="form-check mb-[10px]">
                            <input class="form-check-input appearance-none rounded-full h-4 w-4 border border-gray-300 bg-white checked:bg-blue-600 checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" v-on:click="onChange($event)" type="radio" name="indexRadio" id="bio">
                            <jet-label class="form-check-label inline-block text-gray-800 text-1xl" for="bio">
                                BIO
                            </jet-label>
                        </div>
                        <div class="form-check mb-[10px]">
                            <input class="form-check-input appearance-none rounded-full h-4 w-4 border border-gray-300 bg-white checked:bg-blue-600 checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" v-on:click="onChange($event)" type="radio" name="indexRadio" id="rms">
                            <jet-label class="form-check-label inline-block text-gray-800 text-1xl" for="rms">
                                RMS
                            </jet-label>
                        </div>
                    </div>
                ...
                <div class="w-1/2 flex flex-col h-full">
                    ...
                    <div class="flex w-full justify-end content-end align-end mt-[150px]">
                        <jet-button v-on:click="onNext($event)" class="flex w-1/3 justify-center">
                            Next
                        </jet-button>
                    </div>
                </div>
    ...
    export default defineComponent({
        ...
        methods: {
            onChange: function (event) {
                this.selectedIndex = event.target.id.toUpperCase()
