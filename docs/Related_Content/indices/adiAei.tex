...
While the method of taking individual sounds of birds and using ratios of specific calls is much more accurate. It is very difficult to identify those individual calls in an automated fashion. Thus, when using a script to calculate the evenness/diversity of a sounds clip bands of frequencies are often used. An example could be dividing a spectrogram into 5 kHz ranges and then comparing the intensity of each band in ratio of the total intensity of the sound recording. This allows insight into the diversity of the types of frequencies that are within a recording. Since most species have a range for which their calls fall into it can provide an insight into the ratio of types of species.
